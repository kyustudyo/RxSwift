...
class NewsTableViewController_MVVM: UITableViewController {
    
    let disposeBag = DisposeBag()
    private var articleListVM: ArticleListViewModel_MVVM!
    ...
    private func configureUI() {
        ...
        tableView.register(NewsCell_MVVM.self, forCellReuseIdentifier: reuseIdentifier_MVVM)
...
//    }
    private func populateNews() {
        ...
        URLRequest.load(resource: resource)
            .subscribe(onNext: { articleResponse in
                ...
                self.articleListVM = ArticleListViewModel_MVVM(articles)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier_MVVM, for: indexPath) as? NewsCell_MVVM else {return UITableViewCell()}
