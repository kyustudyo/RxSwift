...
//    var score : BehaviorRelay<Int>
//}
//let practice1 = PublishSubject<practice>()
//practice1.flatMap{$0.score.asObservable()}
//.subscribe(onNext:{
//    print($0)
//}).disposed(by: disposeBag)
//let pr1 = practice(score: BehaviorRelay(value: 33))
//practice1.onNext(pr1)
